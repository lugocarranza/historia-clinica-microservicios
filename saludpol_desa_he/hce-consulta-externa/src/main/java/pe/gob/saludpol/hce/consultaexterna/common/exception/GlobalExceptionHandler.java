...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override
    protected @Nullable ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, // NOSONAR
            @Nullable HttpHeaders headers, HttpStatusCode statusCode, WebRequest request) {
    ...
    @Override
    protected @Nullable ResponseEntity<Object> handleTypeMismatch(TypeMismatchException ex, @Nullable HttpHeaders headers, // NOSONAR
        ...
        String requiredType = mismatchEx.getRequiredType() != null
                ? mismatchEx.getRequiredType().getSimpleName() : "tipo desconocido";
    ...
    @Override
    protected @Nullable ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex, // NOSONAR
            @Nullable HttpHeaders headers, HttpStatusCode statusCode, WebRequest request) {
        HttpStatus status = resolveStatus(statusCode, HttpStatus.BAD_REQUEST);
    ...
    @Override
    protected @Nullable ResponseEntity<Object> handleMissingServletRequestParameter( // NOSONAR
            MissingServletRequestParameterException ex, @Nullable HttpHeaders headers,
            HttpStatusCode statusCode, WebRequest request) {
        HttpStatus status = resolveStatus(statusCode, HttpStatus.BAD_REQUEST);
